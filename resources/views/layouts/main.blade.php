        ...
        <div class="container mx-auto flex items-center justify-between px-4 py-6">
            ...
            <div class="flex items-center">
                <div class="relative">
                    <input
                     type="text"
                     class="bg-gray-800 rounded-full pl-8 w6 px-4 py-1 focus:outline-none focus::shadow-outline"
