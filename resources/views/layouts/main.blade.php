    ...
    <nav class="border-b border-gray-900">
        <div class="container mx-auto  flex flex-col md:flex-row  items-center justify-between px-4 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16">
                    <a href="#" class="hover::text-gray-300 mt-4 md:mt-0">Movies</a>
                </li>
                <li class="md:ml-6">
            ...
            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-4 md:mt-0">
                    <input
                     type="text"
                     class="bg-gray-800 rounded-full pl-8 w6 px-4 py-1 focus:outline-none focus::shadow-outline text-sm"
                        ...
                        fill="none"
                         ...
                         stroke-width="1.5"
                          class="w-5 h-5 mt-1 ml-2"
                           viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607z"/></svg>
                     </div>
                </div>
